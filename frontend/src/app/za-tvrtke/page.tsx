  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => (
              <SlideUp key={feature.title} delay={index * 0.08}>
                <div className="card">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-foreground/10 bg-foreground/5">
          ...
          <div className="grid grid-cols-2 items-center gap-6 md:grid-cols-4">
            {[
              ...
              <SlideUp key={name} delay={index * 0.08}>
                <div className="flex items-center gap-3 rounded-2xl border border-black/5 bg-black/[0.02] p-4 dark:border-white/5 dark:bg-white/[0.02]">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl border border-foreground/10 bg-foreground/5">
      ...
      <section className="py-20">
        <div className="container mx-auto max-w-5xl px-4">
          <SlideUp>
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-emerald-500 to-teal-500 p-10 text-center md:p-14">
