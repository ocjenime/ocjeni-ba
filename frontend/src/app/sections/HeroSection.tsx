    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 pt-32 pb-24 text-center lg:px-8">
        ...
        <motion.h1
          ...
          className="font-[family-name:var(--font-space-grotesk)] text-5xl font-semibold tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl"
        >
          Pronađi.
          <br />
        ...
        >
          <div className="relative flex-1">
            <input
              ...
              className="h-14 w-full rounded-full border border-white/15 bg-white/5 px-6 pr-12 text-white placeholder-white/40 outline-none backdrop-blur-sm transition-colors focus:border-emerald-400/50"
            />
            <Search className="absolute right-5 top-1/2 h-5 w-5 -translate-y-1/2 text-white/40" />
          </div>
          <button
            type="submit"
          ...
          <Link
            href="/kategorije"
            className="animated-border group relative inline-flex h-14 items-center justify-center overflow-hidden rounded-full border border-white/15 bg-white/5 px-8 text-base font-semibold text-white backdrop-blur-sm transition-all hover:bg-white/10"
          >
